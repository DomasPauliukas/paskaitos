...
function checkPassword (originalPasword: string): string {
...
function checkAge (ages: number): string {
...
function greeting(userLoggedIn: boolean, userName: string, time: number, itsBirthday: boolean) {
...
function task1(start: number, end: number, multiplier: number) {
  if (start <= end) {
...
function task2(start: number, end: number, multiplier: number) {
  if (start <= end) {
    for (let i = start; i <= end; i++) {
      let answer = i * multiplier
      let output = `${i} * ${multiplier} = ${answer}`
...
function task3(start: number, end: number, change: number) {
...
function task4(start: number, end: number, degree: number) {
