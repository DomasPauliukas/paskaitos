...
// **************************************************** 1 BUDAS *********
       ...
       let companyObj: {
        ...
        locations: () => string,
        areas: () => string,
        addCountry: (country: string) => string [],
        addActivity: (activity: string) => string [],
        removeCountry: (country: string) => string [] | undefined,
        removeActivity: (activity: string) => string [] | undefined
       } = {
        'company name': 'Dell',
        opened: 2000,
