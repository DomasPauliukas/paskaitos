let mainTestimonialsData: Testimonials[] = [
    {   
...
let secondaryTestimonialsData: Testimonials[] = [
    {
        name: 'Kira Whittle',
...
function createTestimonialItem (data: Testimonials) {
...
function createElement (className?: string, text?: string, elementType: string = 'div') {
