...
let task4: HTMLHeadingElement = document.createElement('h1')
...
button4.addEventListener('click', () => {
    counter++
    task4.textContent = counter.toString()
})
...
button5.addEventListener('click', () => {
    task5.textContent = Math.floor(Math.random()*100).toString()
})
